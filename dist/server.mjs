...
var createCategory, getAllCategories, getCategoryById, updateCategory, deleteCategory, categoryService;
...
var createCategory2, getAllCategories2, getCategoryById2, updateCategory2, deleteCategory2, categoryController;
...
var authGuard, authGuard_default;
var init_authGuard = __esm({
  "src/middlewares/authGuard.ts"() {
    ...
    authGuard_default = authGuard;
  }
});

// src/modules/category/category.router.ts
import Express from "express";
var categoryRouter, category_router_default;
var init_category_router = __esm({
  "src/modules/category/category.router.ts"() {
    ...
    category_router_default = categoryRouter;
  }
});

// src/modules/medicine/medicine.service.ts
var createMedicine, getAllMedicines, getMedicineById, deleteMedicine, updateMedicine, getAllMedicinesBySellerId, medicineService;
var init_medicine_service = __esm({
  "src/modules/medicine/medicine.service.ts"() {
    "use strict";
    init_prisma();
    createMedicine = async (payload, userId) => {
    ...
    deleteMedicine = async (medicineId, userId) => {
      const medicine = await prisma.medicine.findUnique({
        where: {
          id: medicineId
        }
    ...
    updateMedicine = async (payload, userId, medicineId) => {
    ...
    getAllMedicinesBySellerId = async (sellerId) => {
...
var createMedicine2, getAllMedicines2, getMedicineById2, deleteMedicine2, updateMedicine2, getAllMedicinesBySellerId2, medicineController;
var init_medicine_controller = __esm({
  "src/modules/medicine/medicine.controller.ts"() {
    ...
    getAllMedicinesBySellerId2 = async (req, res) => {
      try {
        const user = req.user;
...
var medicineRouter, medicine_router_default;
var init_medicine_router = __esm({
  "src/modules/medicine/medicine.router.ts"() {
    "use strict";
    init_medicine_controller();
    init_authGuard();
    medicineRouter = Express2.Router();
    medicineRouter.post(
      "/",
    ...
    medicine_router_default = medicineRouter;
  }
});

// src/modules/order/order.service.ts
var createOrder, getUserOrders, getOrderById, getOrderBySellerId, updateOrderStatus, getAllOrders, trackOrderStatus, orderService;
var init_order_service = __esm({
  "src/modules/order/order.service.ts"() {
    ...
    trackOrderStatus = async (orderId, userId) => {
      const order = await prisma.orders.findUnique({
        where: { id: orderId },
        select: {
          id: true,
...
var createOrder2, getUserOrders2, getOrderById2, getOrderBySellerId2, updateOrderStatus2, getAllOrders2, trackOrderStatus2, orderController;
var init_order_controller = __esm({
  "src/modules/order/order.controller.ts"() {
    ...
    getOrderBySellerId2 = async (req, res) => {
      try {
        const user = req.user;
    ...
    trackOrderStatus2 = async (req, res) => {
      try {
        const { id } = req.params;
        const user = req.user;
...
var orderRouter, order_router_default;
var init_order_router = __esm({
  "src/modules/order/order.router.ts"() {
    "use strict";
    init_order_controller();
    init_authGuard();
    orderRouter = Express3.Router();
    orderRouter.post(
      "/",
    ...
    order_router_default = orderRouter;
  }
});

// src/modules/user/user.service.ts
var getAllUsers, userStatusUpdate, userService;
var init_user_service = __esm({
  "src/modules/user/user.service.ts"() {
    ...
    userStatusUpdate = async (id, status) => {
...
var getAllUsers2, userStatusUpdate2, userController;
var init_user_controller = __esm({
  "src/modules/user/user.controller.ts"() {
    ...
    userStatusUpdate2 = async (req, res) => {
      try {
        const { id } = req.params;
        const { status } = req.body;
...
var userRouter, user_router_default;
var init_user_router = __esm({
  "src/modules/user/user.router.ts"() {
    "use strict";
    init_user_controller();
    init_authGuard();
    userRouter = Express4.Router();
    ...
    user_router_default = userRouter;
  }
});

// src/modules/review/review.service.ts
var createCustomerReview, getAllReviewsbyproductId, reviewService;
var init_review_service = __esm({
  "src/modules/review/review.service.ts"() {
    "use strict";
    init_prisma();
    init_authGuard();
    createCustomerReview = async (userId, payload) => {
    ...
    getAllReviewsbyproductId = async (medicineId) => {
...
var createCustomerReview2, getAllReviewsbyproductId2, reviewController;
var init_review_controller = __esm({
  "src/modules/review/review.controller.ts"() {
    "use strict";
    init_review_service();
    createCustomerReview2 = async (req, res) => {
      try {
        const user = req.user;
        console.log(user?.id);
        const payload = {
    ...
    getAllReviewsbyproductId2 = async (req, res) => {
      try {
...
var reviewRouter, review_router_default;
var init_review_router = __esm({
  "src/modules/review/review.router.ts"() {
    "use strict";
    init_review_controller();
    init_authGuard();
    reviewRouter = Express5.Router();
    reviewRouter.post(
      "/",
      authGuard_default("CUSTOMER" /* CUSTOMER */),
    ...
    review_router_default = reviewRouter;
  }
});
